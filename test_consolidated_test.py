...
# Find the Example table element in the page
            table = self.driver.find_element("xpath", "//table[@name='Example Table']")
...
# Find the email field using xpath without id
            email = self.driver.find_element("xpath", "//input[@name='email']")
...
# Set a dropdown
            self.driver.find_element("xpath", "//button[@data-toggle='dropdown']").click()
            time.sleep(1)
# Find the xpath of particular option and click on it
            self.driver.find_element("xpath", "//a[text()='Male']").click()

# Set a checkbox
            checkbox = self.driver.find_element("xpath", "//input[@type='checkbox']")
            checkbox.click()

# Take screenshot
            self.driver.save_screenshot('Qxf2_Tutorial.png')
