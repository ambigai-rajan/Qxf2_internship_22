...
# Create an instance of IE WebDriver
            self.driver = webdriver.Chrome("e:/chromedriver")
...
# KEY POINT:to close the popup
            self.driver.find_element("xpath","//div[@id='onetrust-close-btn-container']").click()
...
# KEY POINT: Check if the validation mesage for name field
            try:
                self.driver.find_element("xpath", "//span[@class='LinkContainer-sc-1t58wcv-0 hngMxV']")
